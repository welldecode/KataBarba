    ...
    <section class="dashboard">
        <div class="dashboard_content container">
            <div class="dashboard_content_title">
                ...
                ?>
                    <h1 data-aos="fade-up" data-aos-delay="700"><?php echo $highlights['title'] ?></h1>
                    <p data-aos="fade-up" data-aos-delay="800"><?php echo $highlights['subtitle'] ?></p>
                <?php
                }
                ?>
            </div>
    ...
    <section class="about container">
        <div class="about_content">
            <div class="about_content_left">
                ...
                <p data-aos="fade-in" data-aos-delay="700">Tenha uma experiência de barbear mais prática e confortável, que pode tornar o processo de barbear em casa mais agradável. Além disso a pessoa que mora com você agradece. Hábitos de higiene são um reflexo de quem você é!</p>
            </div>
            <div class="about_content_right">
                <div class="card_content flex flex_wrap">
                    ...
                    ?>
                        <article class="card_about" data-aos="fade-up" data-aos-delay="<?= $ani;?>00">
                            <figure>
                                <img src="<?php echo $about['image'] ?>" alt="">
                            </figure>
                            <h1><?php echo $about['title'] ?></h1>
                            <h4><?php echo $about['subtitle'] ?></h4>
                        </article>
                    <?php
                    $ani++;
                    }
